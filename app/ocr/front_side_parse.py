...
def get_accurate_info(image, start=100, stop=150, step_size=30, json=False):
 # image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
  ...
  if json:
    ...
    return accurate_citizenship_number, accurate_name_nep, accurate_gender, accurate_dob, accurate_birth_district, accurate_permanent_district, accurate_birth_ward, accurate_permanent_ward


if __name__ == '__main__':
  image = cv2.imread("../test/b_front.jpg")
